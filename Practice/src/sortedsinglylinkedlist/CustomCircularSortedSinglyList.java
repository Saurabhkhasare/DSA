...
public class CustomCircularSortedSinglyList {
    ...
    public CustomCircularSortedSinglyList() {
        head = null;
    }

    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
        	CustomCircularSortedSinglyList list = new CustomCircularSortedSinglyList();
